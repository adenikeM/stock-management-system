...
public class ProductOrderService {
    ...
    public List<ProductOrder> getAllProductOrder(){return productOrderRepository.findAll();}
    public Optional<ProductOrder> getAllProductOrderByID(Integer productOrderId){return productOrderRepository.findById(productOrderId);}
    public ProductOrder createProductOrder(ProductOrder productOrder){return productOrderRepository.save(productOrder);}
